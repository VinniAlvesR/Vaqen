    ...
    <main className="min-h-screen bg-slate-50 px-4 py-6 text-slate-950 sm:px-6 lg:px-8 dark:bg-slate-950 dark:text-white">
      <section className="mx-auto max-w-4xl rounded-[2rem] border border-slate-200 bg-white p-6 shadow-sm sm:p-8 dark:border-slate-800 dark:bg-slate-900">
        <div className="flex items-center gap-3">
          <Image src="/vaqen-icon.svg" alt="" width={48} height={48} className="rounded-2xl border border-white bg-white" priority />
          <div>
        ...
        <Link href="/dashboard" className="mt-8 inline-flex rounded-full bg-indigo-600 px-5 py-3 text-sm font-bold text-white transition hover:bg-indigo-700">Voltar ao dashboard</Link>
      </section>
    </main>
  )
}